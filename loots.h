...
class CfgLootTable
{
	...
	class Equipment
	{
		items[] = {
				...
				// MAS
				{ { "Rangefinder_mas_h", "weapon" }, 5 },
				//{ { "Laserdesignator_mas_h", "weapon" }, 1 },
				//{ { "NVGoggles_mas_h", "item" }, 10 },
				{ { "acc_mas_pointer_IR", "item" }, 20 },
				{ { "acc_mas_pointer_IR_top", "item" }, 20 },
				{ { "acc_mas_pointer_IR2", "item" }, 20 },
				{ { "acc_mas_pointer_IR2_top", "item" }, 20 },
				{ { "acc_mas_pointer_IR2c", "item" }, 20 },
	...
	class SniperRifle
	{
		items[] = {
				...
				//MAS
				{ { "srifle_mas_ksvk", "weapon" }, 8 },
				{ { "srifle_mas_ksvk_c", "weapon" }, 8 },
				{ { "srifle_mas_svd", "weapon" }, 14 },
				{ { "srifle_mas_m91", "weapon" }, 14 },
				{ { "srifle_mas_vss", "weapon" }, 14 },
				{ { "srifle_mas_hk417", "weapon" }, 18 },   
				{ { "srifle_mas_hk417_v", "weapon" }, 18 },  
				{ { "srifle_mas_hk417_d", "weapon" }, 18 }, 
				{ { "srifle_mas_sr25", "weapon" }, 18 }, 
				{ { "srifle_mas_sr25_v", "weapon" }, 18 },  
				{ { "srifle_mas_sr25_d", "weapon" }, 18 },
				{ { "srifle_mas_ebr", "weapon" }, 18 }, 
				{ { "srifle_mas_mk17s", "weapon" }, 18 }, 
				{ { "srifle_mas_m110", "weapon" }, 12 }, 
				{ { "srifle_mas_m24", "weapon" }, 14 }, 
				{ { "srifle_mas_m24_v", "weapon" }, 14 },  
				{ { "srifle_mas_m24_d", "weapon" }, 14 },
				{ { "srifle_mas_lrr", "weapon" }, 12 }
		};
	};
	...
	class SniperRiflem107
	{
		items[] = {
				...
				//MAS
				{ { "srifle_mas_m107", "weapon" }, 1 },
				{ { "srifle_mas_m107_v", "weapon" }, 1 },
				{ { "srifle_mas_m107_d", "weapon" }, 1 }
		};
	};
	...
	class SniperRifleAmmo
	{
		items[] = {
				...
				{ { "20Rnd_mas_762x51_T_Stanag", "magazine" }, 1 },
				{ { "5Rnd_mas_127x99_Stanag", "magazine" }, 1 },
				{ { "5Rnd_mas_127x99_dem_Stanag", "magazine" }, 1 },
				{ { "5Rnd_mas_127x99_T_Stanag", "magazine" }, 1 },
				{ { "10Rnd_mas_338_Stanag", "magazine" }, 1 },	
				{ { "10Rnd_mas_338_T_Stanag", "magazine" }, 1 },
				{ { "10Rnd_mas_762x54_mag", "magazine" }, 1 }, 
				{ { "10Rnd_mas_762x54_T_mag", "magazine" }, 1 },
				{ { "20Rnd_mas_9x39_mag", "magazine" }, 1 },
				{ { "30Rnd_mas_9x39_mag", "magazine" }, 1 }
		};
	};
	...
	class SniperRifleAmmo_5Rnd_127x108_Mag
	{
		items[] = {
				...
				//MAS
				{ { "5Rnd_mas_127x108_mag", "magazine" }, 1 },
				{ { "5Rnd_mas_127x108_T_mag", "magazine" }, 1 },
				{ { "5Rnd_mas_127x108_T_dem_mag", "magazine" }, 1 }
		};
	};
	...
	class Rifle
	{
		items[] = {
				...
				//MAS
				{ { "arifle_mas_hk416", "weapon" }, 7 },  
				{ { "arifle_mas_hk416_gl", "weapon" }, 7 },  
				{ { "arifle_mas_hk416_m203", "weapon" }, 7 },  
				{ { "arifle_mas_hk416_v", "weapon" }, 7 }, 
				{ { "arifle_mas_hk416_gl_v", "weapon" }, 7 },  
				{ { "arifle_mas_hk416_m203_v", "weapon" }, 7 }, 
				{ { "arifle_mas_hk416_d", "weapon" }, 7 }, 
				{ { "arifle_mas_hk416_gl_d", "weapon" }, 7 }, 
				{ { "arifle_mas_hk416_m203_d", "weapon" }, 7 },
				{ { "arifle_mas_hk416c", "weapon" }, 7 }, 
				{ { "arifle_mas_hk416_m203c", "weapon" }, 7 }, 
				{ { "arifle_mas_hk416c_v", "weapon" }, 7 },
				{ { "arifle_mas_hk416_m203c_v", "weapon" }, 7 },
				{ { "arifle_mas_hk416c_d", "weapon" }, 7 },
				{ { "arifle_mas_hk416_m203c_d", "weapon" }, 7 },  
				{ { "arifle_mas_hk417c", "weapon" }, 7 }, 
				{ { "arifle_mas_hk417_m203c", "weapon" }, 7 },  
				{ { "arifle_mas_hk417c_v", "weapon" }, 7 },  
				{ { "arifle_mas_hk417_m203c_v", "weapon" }, 7 }, 
				{ { "arifle_mas_hk417c_d", "weapon" }, 7 },  
				{ { "arifle_mas_hk417_m203c_d", "weapon" }, 7 },  
				{ { "arifle_mas_m4", "weapon" }, 7 }, 
				{ { "arifle_mas_m4_gl", "weapon" }, 7 }, 
				{ { "arifle_mas_m4_m203", "weapon" }, 7 }, 
				{ { "arifle_mas_m4_v", "weapon" }, 7 }, 
				{ { "arifle_mas_m4_m203_v", "weapon" }, 7 }, 
				{ { "arifle_mas_m4_d", "weapon" }, 7 }, 
				{ { "arifle_mas_m4_gl_d", "weapon" }, 7 }, 
				{ { "arifle_mas_m4_m203_d", "weapon" }, 7 }, 
				{ { "arifle_mas_m4c", "weapon" }, 7 }, 
				{ { "arifle_mas_m4_m203c", "weapon" }, 7 },
				{ { "arifle_mas_m4c_v", "weapon" }, 7 },  
				{ { "arifle_mas_m4_m203c_v", "weapon" }, 7 },  
				{ { "arifle_mas_m4c_d", "weapon" }, 7 }, 
				{ { "arifle_mas_m4_m203c_d", "weapon" }, 7 }, 
				{ { "arifle_mas_l119", "weapon" }, 7 }, 
				{ { "arifle_mas_l119_gl", "weapon" }, 7 },
				{ { "arifle_mas_l119_m203", "weapon" }, 7 }, 
				{ { "arifle_mas_l119_v", "weapon" }, 7 }, 
				{ { "arifle_mas_l119_gl_v", "weapon" }, 7 }, 
				{ { "arifle_mas_l119_m203_v", "weapon" }, 7 }, 
				{ { "arifle_mas_l119_d", "weapon" }, 7 }, 
				{ { "arifle_mas_l119_gl_d", "weapon" }, 7 }, 
				{ { "arifle_mas_l119_m203_d", "weapon" }, 7 }, 
				{ { "arifle_mas_mk16", "weapon" }, 4 }, 
				{ { "arifle_mas_mk16_l", "weapon" }, 4 }, 
				{ { "arifle_mas_mk17", "weapon" }, 4 }, 
				{ { "arifle_mas_mk17_gl", "weapon" }, 4 }, 
				{ { "arifle_mas_g3", "weapon" }, 7 }, 
				{ { "arifle_mas_g3_m203", "weapon" }, 7 }, 
				{ { "arifle_mas_g3s", "weapon" }, 7 }, 
				{ { "arifle_mas_g3s_m203", "weapon" }, 7 }, 
				{ { "arifle_mas_fal", "weapon" }, 5 }, 
				{ { "arifle_mas_fal_m203", "weapon" }, 5 }, 
				{ { "arifle_mas_m1014", "weapon" }, 7 },
				{ { "arifle_mas_mp5", "weapon" }, 7 }, 
				{ { "arifle_mas_mp5_v", "weapon" }, 7 }, 
				{ { "arifle_mas_mp5_d", "weapon" }, 7 }, 
				{ { "arifle_mas_mp5sd", "weapon" }, 7 }, 
				{ { "arifle_mas_ak_74m", "weapon" }, 7 }, 
				{ { "arifle_mas_ak_74m_gl", "weapon" }, 7 },
				{ { "arifle_mas_ak_74m_c", "weapon" }, 7 }, 
				{ { "arifle_mas_ak_74m_gl_c", "weapon" }, 7 },
				{ { "arifle_mas_aks74", "weapon" }, 7 }, 
				{ { "arifle_mas_aks74_gl", "weapon" }, 7 }, 
				{ { "arifle_mas_ak_74m_sf", "weapon" }, 7 }, 
				{ { "arifle_mas_ak_74m_sf_gl", "weapon" }, 7 }, 
				{ { "arifle_mas_ak_74m_sf_c", "weapon" }, 7 }, 
				{ { "arifle_mas_ak_74m_sf_gl_c", "weapon" }, 7 }, 
				{ { "arifle_mas_akms", "weapon" }, 7 }, 
				{ { "arifle_mas_akms_gl", "weapon" }, 7 },
				{ { "arifle_mas_akms_c", "weapon" }, 7 }, 
				{ { "arifle_mas_akms_gl_c", "weapon" }, 7 }, 
				{ { "arifle_mas_akm", "weapon" }, 7 }, 
				{ { "arifle_mas_akm_gl", "weapon" }, 7 }, 
				{ { "arifle_mas_bizon", "weapon" }, 5 }, 
				{ { "arifle_mas_saiga", "weapon" }, 7 },
				{ { "arifle_mas_m70", "weapon" }, 7 }, 
				{ { "arifle_mas_m70_gl", "weapon" }, 7 }, 
				{ { "arifle_mas_m70ab", "weapon" }, 7 }, 
				{ { "arifle_mas_m70ab_gl", "weapon" }, 7 },
				{ { "arifle_mas_aks74u", "weapon" }, 7 }, 
				{ { "arifle_mas_aks74u_c", "weapon" }, 7 }, 
				{ { "arifle_mas_g36c", "weapon" }, 7 },
				{ { "arifle_mas_asval", "weapon" }, 4 },
				{ { "arifle_mas_lee", "weapon" }, 14 },
				{ { "arifle_mas_l119c", "weapon" }, 7 },
				{ { "arifle_mas_l119c_v", "weapon" }, 7 },
				{ { "arifle_mas_l119c_d", "weapon" }, 7 }
		};
	};
	...
	class RifleAmmo
	{
		items[] = {
				...
				//MAS
				{ { "30Rnd_mas_9x21_Stanag", "magazine" }, 17 },
				{ { "30Rnd_mas_9x21d_Stanag", "magazine" }, 17 },
				{ { "64Rnd_mas_9x18_mag", "magazine" }, 8 },
				{ { "30Rnd_mas_762x39_mag", "magazine" }, 8 },
				{ { "30Rnd_mas_762x39_T_mag", "magazine" }, 8 },
				{ { "30Rnd_mas_545x39_mag", "magazine" }, 12 },
				{ { "30Rnd_mas_545x39_T_mag", "magazine" }, 12 },
				{ { "40Rnd_mas_46x30_Mag", "magazine" }, 8 },
				{ { "10Rnd_mas_12Gauge_Slug", "magazine" }, 12 },
				{ { "10Rnd_mas_12Gauge_Pellets", "magazine" }, 8 }
		};
	};
	...
	class RifleAmmo_30Rnd_556x45_Stanag
	{
		items[] = {
				...
				// MAS
				{ { "30Rnd_mas_556x45_Stanag", "magazine" }, 4 }, 
				{ { "30Rnd_mas_556x45_T_Stanag", "magazine" }, 2 },
		};
	};
	...
	class Machinegun
	{
		items[] = {
				...
				// MAS
				{ { "LMG_mas_Mk200_F", "weapon" }, 4 },  
				{ { "LMG_mas_Mk48_F", "weapon" }, 1 }, 
				{ { "LMG_mas_Mk48_F_v", "weapon" }, 1 }, 
				{ { "LMG_mas_Mk48_F_d", "weapon" }, 1 }, 
				{ { "LMG_mas_M240_F", "weapon" }, 3 }, 
				{ { "LMG_mas_mg3_F", "weapon" }, 1 },
				{ { "LMG_mas_rpk_F", "weapon" }, 3 }, 
				{ { "LMG_mas_pkm_F", "weapon" }, 1 },
				{ { "LMG_mas_M60_F", "weapon" }, 3 }, 
				{ { "LMG_mas_m72_F", "weapon" }, 3 } 
		};
	};
	...
	class Machinegun_m249_EPOCH
	{
		items[] = {
				...
				//MAS            
				{ { "LMG_mas_M249_F", "weapon" }, 1 }, 
				{ { "LMG_mas_M249_F_v", "weapon" }, 1 }, 
				{ { "LMG_mas_M249_F_d", "weapon" }, 1 }, 
				{ { "LMG_mas_M249a_F", "weapon" }, 1 }
		};
	};
...
//MAS
				{ { "200Rnd_mas_556x45_Stanag", "magazine" }, 25 },
				{ { "200Rnd_mas_556x45_T_Stanag", "magazine" }, 25 },
				{ { "100Rnd_mas_762x39_mag", "magazine" }, 25 },
				{ { "100Rnd_mas_762x39_T_mag", "magazine" }, 25 },
				{ { "100Rnd_mas_545x39_mag", "magazine" }, 25 },
				{ { "100Rnd_mas_545x39_T_mag", "magazine" }, 25 },
				{ { "100Rnd_mas_762x54_mag", "magazine" }, 25 },
				{ { "100Rnd_mas_762x54_T_mag", "magazine" }, 25 }
	...
	class MachinegunAmmo_200Rnd_65x39_cased_Box
	{
		items[] = {
				...
				//MAS
				{ { "100Rnd_mas_762x51_Stanag", "magazine" }, 1 },
				{ { "100Rnd_mas_762x51_T_Stanag", "magazine" }, 1 }
		};
	};
	/*
	...
	*/
	...
	class Pistols
	{
		items[] = {
				...
				{ { "hgun_mas_sa61_F", "weapon" }, 5 },
				{ { "hgun_mas_mak_F", "weapon" }, 14 }, 
				{ { "hgun_mas_m9_F", "weapon" }, 14 }, 
				{ { "hgun_mas_bhp_F", "weapon" }, 14 }, 
				{ { "hgun_mas_glock_F", "weapon" }, 14 }, 
				{ { "hgun_mas_acp_F", "weapon" }, 14 }, 
				{ { "hgun_mas_usp_F", "weapon" }, 14 }, 
				{ { "hgun_mas_glocksf_F", "weapon" }, 14 }, 
				{ { "hgun_mas_grach_F",  "weapon" }, 14 },
				{ { "hgun_mas_mp7_F", "weapon" }, 5 }
		};
	};
	class PistolAmmo
	{
...
//MAS
				{ { "25Rnd_mas_9x19_Mag", "magazine" }, 10 },
				{ { "17Rnd_mas_9x21_Mag", "magazine" }, 16 },
				{ { "16Rnd_9x21_Mag", "magazine" }, 16 },
				{ { "15Rnd_mas_9x21_Mag", "magazine" }, 16 }, 
				{ { "13Rnd_mas_9x21_Mag", "magazine" }, 16 },
				{ { "20Rnd_mas_765x17_Mag", "magazine" }, 10 },
				{ { "12Rnd_mas_45acp_Mag", "magazine" }, 12 },
				{ { "10Rnd_mas_45acp_Mag", "magazine" }, 12 },
				{ { "8Rnd_mas_45acp_Mag", "magazine" }, 16 },
				{ { "13Rnd_mas_9x21_Mag", "magazine" }, 16 },
				{ { "8Rnd_mas_9x18_Mag", "magazine" }, 16 }   
		};
	};
	class Scopes
	{
		items[] = {
				...
				//MAS
				{ { "optic_mas_zeiss", "item" }, 4 }, 
				{ { "optic_mas_zeiss_c", "item" }, 4 },  
				{ { "optic_mas_zeiss_eo", "item" }, 4 },  
				{ { "optic_mas_zeiss_eo_c", "item" }, 4 },  
				{ { "optic_mas_acog", "item" }, 4 },  
				{ { "optic_mas_acog_c", "item" }, 4 },  
				{ { "optic_mas_acog_eo", "item" }, 4 },  
				{ { "optic_mas_acog_eo_c", "item" }, 4 },  
				{ { "optic_mas_acog_rd", "item" }, 4 },  
				{ { "optic_mas_acog_rd_c", "item" }, 4 },  
				{ { "optic_mas_handle", "item" }, 4 },  
				{ { "optic_mas_aim", "item" }, 4 },  
				{ { "optic_mas_aim_c", "item" }, 4 },  
				{ { "optic_mas_pso", "item" }, 4 },  
				{ { "optic_mas_pso_c", "item" }, 4 },  
				{ { "optic_mas_pso_eo", "item" }, 4 },  
				{ { "optic_mas_pso_eo_c", "item" }, 4 },  
				{ { "optic_mas_pso_nv",  "item" }, 1 },
				{ { "optic_mas_pso_nv_c", "item" }, 1 }, 
				{ { "optic_mas_pso_nv_eo", "item" }, 1 }, 
				{ { "optic_mas_pso_nv_eo_c", "item" }, 1 }, 
				{ { "optic_mas_term", "item" }, 1 }, 
                { { "optic_mas_goshawk", "item" }, 1 }, 
				{ { "optic_mas_DMS", "item" }, 3 }, 
				{ { "optic_mas_DMS_c", "item" }, 3 }, 
				{ { "optic_mas_Holosight_blk", "item" }, 6 }, 
				{ { "optic_mas_Holosight_camo", "item" }, 6 },
				{ { "optic_mas_Arco_blk", "item" }, 5 }, 
				{ { "optic_mas_Arco_camo", "item" }, 5 }, 
				{ { "optic_mas_Hamr_camo", "item" }, 6 }, 
				{ { "optic_mas_Aco_camo", "item" }, 7 }, 
				{ { "optic_mas_ACO_grn_camo", "item" }, 7 }, 
				{ { "optic_mas_MRCO_camo", "item" }, 6 },
				{ { "optic_mas_nspu", "item" }, 1 }
		};
	};
	...
	class Muzzles
	{
		items[] = {
				...
				//MAS
				{ { "muzzle_mas_snds_L", "item" }, 1 }, 
                { { "muzzle_mas_snds_LM", "item" }, 1 }, 
                { { "muzzle_mas_snds_C", "item" }, 1 },
                { { "muzzle_mas_snds_M", "item" }, 1 }, 
                { { "muzzle_mas_snds_Mc", "item" }, 1 }, 
                { { "muzzle_mas_snds_AK", "item" }, 1 }, 
                { { "muzzle_mas_snds_SM", "item" }, 1 },
                { { "muzzle_mas_snds_SMc", "item" }, 1 },
                { { "muzzle_mas_snds_SH", "item" }, 1 }, 
                { { "muzzle_mas_snds_SHc", "item" }, 1 }, 
                { { "muzzle_mas_snds_SV", "item" }, 1 }, 
                { { "muzzle_mas_snds_SVc", "item" }, 1 }, 
                { { "muzzle_mas_snds_SVD", "item" }, 1 }, 
                { { "muzzle_mas_snds_KSVK", "item" }, 1 },
                { { "muzzle_mas_snds_MP5SD6", "item" }, 1 },
                { { "muzzle_mas_snds_MP7", "item" }, 1 }
		};
	};	
	...
	class HeadgearNoArmor
	{
		items[] = {
				...
				//MAS
				{ { "G_mas_wpn_gog", "item" }, 1 },
				{ { "G_mas_wpn_gog_d", "item" }, 1 },
				{ { "G_mas_wpn_gog_m", "item" }, 1 },
				{ { "G_mas_wpn_gog_md", "item" }, 1 },
				{ { "G_mas_wpn_gog_g", "item" }, 1 },
				{ { "G_mas_wpn_gog_gd", "item" }, 1 },
				{ { "G_mas_wpn_mask", "item" }, 1 },
				{ { "G_mas_wpn_mask_b", "item" }, 1 },
				{ { "G_mas_wpn_wrap", "item" }, 1 },
				{ { "G_mas_wpn_wrap_f", "item" }, 1 },
				{ { "G_mas_wpn_wrap_t", "item" }, 1 },
				{ { "G_mas_wpn_wrap_b", "item" }, 1 },
				{ { "G_mas_wpn_wrap_c", "item" }, 1 },
				{ { "G_mas_wpn_wrap_g", "item" }, 1 },
				{ { "G_mas_wpn_wrap_gog", "item" }, 1 },
				{ { "G_mas_wpn_wrap_gog_f", "item" }, 1 },
				{ { "G_mas_wpn_wrap_gog_t", "item" }, 1 },
				{ { "G_mas_wpn_wrap_gog_b", "item" }, 1 },
				{ { "G_mas_wpn_wrap_gog_c", "item" }, 1 },
				{ { "G_mas_wpn_wrap_gog_g", "item" }, 1 },
				{ { "G_mas_wpn_wrap_mask", "item" }, 1 },
				{ { "G_mas_wpn_wrap_mask_t", "item" }, 1 },
				{ { "G_mas_wpn_wrap_mask_f", "item" }, 1 },
				{ { "G_mas_wpn_wrap_mask_b", "item" }, 1 },
				{ { "G_mas_wpn_wrap_mask_c", "item" }, 1 },
				{ { "G_mas_wpn_wrap_mask_g", "item" }, 1 },
				{ { "G_mas_wpn_bala", "item" }, 1 },
				{ { "G_mas_wpn_bala_b", "item" }, 1 },
				{ { "G_mas_wpn_bala_t", "item" }, 1 },
				{ { "G_mas_wpn_bala_gog", "item" }, 1 },
				{ { "G_mas_wpn_bala_gog_b", "item" }, 1 },
				{ { "G_mas_wpn_bala_gog_t", "item" }, 1 },
				{ { "G_mas_wpn_bala_mask", "item" }, 1 },
				{ { "G_mas_wpn_bala_mask_b", "item" }, 1 },
				{ { "G_mas_wpn_bala_mask_t", "item" }, 1 },
				{ { "G_mas_wpn_shemag", "item" }, 1 },
				{ { "G_mas_wpn_shemag_r", "item" }, 1 },
				{ { "G_mas_wpn_shemag_w", "item" }, 1 },
				{ { "G_mas_wpn_shemag_gog", "item" }, 1 },
				{ { "G_mas_wpn_shemag_mask", "item" }, 1 }
		};
	};
};
